 ...
 *
 *  The exception is a skill that declares itself INTERNAL, which describes how
 *  this machine works inside. Those are left out unless this machine is flagged
 *  internal on the Platform. The agent still loads them either way; this is what
 *  the list says, not what the machine has. */
